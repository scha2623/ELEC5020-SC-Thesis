...
contract PrescriptionManagementSystem {
    ...
    modifier onlyDoctor() {
        ...
        require(
            UsersDetails[msg.sender].status == CurStatus.Active,
    ...
    function getAllUsers() public view onlyOwner returns (UserInfo[] memory) {
    ...
    function getPatientPrescriptions(address patientAddress) public view onlyDoctor() returns (Prescription[] memory) {
